-- =============================================
-- WasteMap Seed Data - Bangalore (SAFE VERSION)
-- This temporarily disables rate limiting for bulk insert
-- =============================================

-- Step 1: Temporarily disable rate limit trigger
DROP TRIGGER IF EXISTS check_rate_limit_trigger ON drop_spots;

-- Step 2: Create system user for seeded data
...
-- =============================================
-- Step 3: Re-enable rate limit trigger
-- =============================================
...
-- =============================================
SELECT COUNT(*) as total_spots FROM drop_spots;
